class OboiDlp < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/forshaws/homebrew-oboi-dlp/releases/download/v0.1.1/oboi-dlp-darwin-arm64.tar.gz"
      sha256 "05714ebe83536b7d0fd266383c67f46b897400db4aec8d19b5eba580d626adf4"
    else
      url "https://github.com/forshaws/homebrew-oboi-dlp/releases/download/v0.1.1/oboi-dlp-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/forshaws/homebrew-oboi-dlp/releases/download/v0.1.1/oboi-dlp-linux-amd64.tar.gz"
